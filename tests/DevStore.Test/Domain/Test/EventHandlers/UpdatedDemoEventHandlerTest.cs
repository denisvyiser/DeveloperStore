...
//{
//    public class UpdatedDemoEventHandlerTest
//    {
//        private readonly Mock<IEventStoreRepository> eventStoreRepositoryMock;

//        private readonly UpdatedDemoEventHandler addedDemoEventHandler;

//        Mock<IIdentificationResolver> identificationResolverMock;

//        public UpdatedDemoEventHandlerTest()
//        {
...
//            addedDemoEventHandler = new UpdatedDemoEventHandler(eventStoreRepositoryMock.Object, identificationResolverMock.Object);

//        }

//        [Fact]
//        public async Task UpdatedDemoEventHandler_Should_()
//        {
//            await addedDemoEventHandler.Handle(new UpdatedDemoEvent(new Demo(Guid.NewGuid(), "Demo 1")), CancellationToken.None);
//        }
//    }
//}
